      ...
      secoes: [
        ...
        },
        {
          ...
          artigos: [
            ...
            { id: 'lep_52', artigo: 'Art. 52', titulo: 'RDD - Regime Disciplinar Diferenciado', frente: 'Quais são as características do RDD?', verso: 'PRAZO: até 2 anos, sem prejuízo de repetição da sanção por nova falta grave de mesma espécie (não existe mais o antigo limite de 1/6 da pena, revogado pelo Pacote Anticrime). RECOLHIMENTO: cela individual. VISITAS: QUINZENAIS (a cada 15 dias — ATENÇÃO: não é semanal, isso é pegadinha clássica), de 2 pessoas por vez, em instalações que impeçam contato físico, com duração de 2 horas. BANHO DE SOL: 2 horas por dia, em grupos de até 4 presos. Aplica-se ao condenado ou preso provisório que apresentar alto risco, ou envolvimento com organização criminosa (independente de falta grave, nesse último caso).', cobrado: 'hot', anos: ['2024', '2023', '2021'] },
      ...
      secoes: [
        {
          ...
          artigos: [
            { id: 'h_1', artigo: 'Art. 1º', titulo: 'Crimes Hediondos', frente: 'Cite os principais crimes hediondos previstos na Lei 8.072/90.', verso: 'Homicídio doloso qualificado; Feminicídio (Art. 121-A, crime autônomo desde a Lei 14.994/2024); Latrocínio; Extorsão mediante sequestro; Estupro e estupro de vulnerável; Epidemia com morte; Falsificação de medicamento; Genocídio; Posse/porte de armas de uso restrito; Mutilação genital. EQUIPARADOS: Terrorismo, Tortura, Tráfico de drogas.', cobrado: 'hot', anos: ['2024', '2023', '2022'] },
            { id: 'h_2', artigo: 'Art. 2º', titulo: 'Características dos Crimes Hediondos', frente: 'Quais são as características dos crimes hediondos?', verso: 'São INSUSCETÍVEIS de: anistia, graça e indulto (inciso I); fiança (inciso II). A pena é cumprida em regime INICIALMENTE FECHADO (§1º). ATENÇÃO — ATUALIZAÇÃO IMPORTANTE: a antiga vedação à LIBERDADE PROVISÓRIA foi RETIRADA do texto legal pela Lei 11.464/2007 — hoje o art. 2º, II só veda FIANÇA, não mais liberdade provisória (que pode ser concedida sem fiança, a critério do juiz). E o regime "integralmente fechado" (redação original de 1990) foi declarado INCONSTITUCIONAL pelo STF (HC 111.840/2012), substituído por "inicialmente fechado", com progressão possível (Art. 112 LEP: 40% primário / 60% reincidente).', cobrado: 'hot', anos: ['2024', '2023'] },
            ...
            { id: 'h_penas', artigo: 'Art. 1º §1º e §2º', titulo: 'Homicídio — Causas de Aumento', frente: 'Quando o homicídio doloso qualificado é hediondo, o que aumenta a pena?', verso: 'O homicídio doloso qualificado (art. 121, §2º do CP) é hediondo. As qualificadoras atuais são: motivo torpe, fútil, veneno/fogo/asfixia, traição/emboscada, menor de 14 ou maior de 60 anos/deficiente/gestante. Causas de aumento especial: §7º do art. 121 CP (milícia, grupo extermínio). ATENÇÃO — MUDOU EM 2024: o FEMINICÍDIO NÃO é mais qualificadora do art. 121 (o antigo inciso VI, §2º, foi revogado) — a Lei 14.994/2024 o transformou em crime autônomo (Art. 121-A), com pena própria de 20 a 40 anos, mas continua sendo hediondo.', cobrado: 'medium', anos: ['2023'] },
      ...
      secoes: [
        {
          ...
          artigos: [
            ...
            { id: 'd_44', artigo: 'Art. 44', titulo: 'Inafiançabilidade do Tráfico', frente: 'O crime de tráfico é inafiançável? E quanto à liberdade provisória e à conversão em penas restritivas de direitos?', verso: 'TEXTO LITERAL da lei (nunca alterado pelo Congresso): os crimes dos arts. 33 caput/§1º e 34 a 37 são INAFIANÇÁVEIS e INSUSCETÍVEIS de sursis, graça, indulto, anistia, liberdade provisória, vedada a conversão em restritivas de direitos. ATENÇÃO — POSIÇÃO ATUAL (o que vale na prática e o que a banca costuma cobrar): o STF declarou INCONSTITUCIONAL a vedação à LIBERDADE PROVISÓRIA (HC 104.339/2012) — hoje ela PODE ser concedida, avaliado o caso concreto. O STF também considerou inconstitucional vedar a CONVERSÃO em restritivas de direitos no tráfico privilegiado (art. 33, §4º — HC 97.256/2010, com efeitos estendidos pelo Senado). Ou seja: o texto do Art. 44 continua escrito assim, mas não é mais aplicado dessa forma pelos tribunais — questões de prova costumam cobrar exatamente essa diferença entre "letra da lei" e "entendimento do STF".', cobrado: 'hot', anos: ['2023', '2022'] },
      ...
      secoes: [
        {
          ...
          artigos: [
            ...
            { id: 't_jurisdicao', artigo: 'Art. 1º §5º', titulo: 'Condenação Comunicada', frente: 'Qual o efeito da condenação de agente público por tortura em relação ao cargo?', verso: 'A condenação acarretará a perda do cargo, função ou emprego público e a interdição para seu exercício pelo dobro do prazo da pena aplicada. ATENÇÃO — PEGADINHA CLÁSSICA: na Lei de Tortura essa perda de cargo É EFEITO AUTOMÁTICO da condenação (basta o trânsito em julgado, sem necessidade de motivação específica do juiz sobre esse ponto), ao contrário da regra geral do Art. 92 do CP (onde a perda do cargo é efeito EXTRAPENAL que precisa ser motivadamente declarado na sentença).', cobrado: 'hot', anos: ['2023', '2022'] }
          ]
        }
      ]
    },
      ...
      secoes: [
        ...
        },
        {
          ...
          artigos: [
            ...
            { id: 'mp_19', artigo: 'Art. 19', titulo: 'Concessão das Medidas Protetivas', frente: 'Quem concede as medidas protetivas e qual o prazo?', verso: 'Regra geral: o JUIZ concede em 48 horas, ao receber o expediente policial. Pode ser concedida a qualquer hora do dia ou da noite. NÃO depende de audiência das partes nem de manifestação do MP (de forma geral — urgência). ATUALIZAÇÃO — Lei 13.827/2019 (Art. 12-C): em caráter EXCEPCIONAL e PROVISÓRIO, quando houver risco atual ou iminente à vida ou integridade física da vítima, o AFASTAMENTO DO AGRESSOR DO LAR pode ser decretado também pelo DELEGADO DE POLÍCIA (no município que não for sede de comarca) ou até por POLICIAL (se não houver delegado disponível), devendo o juiz ser comunicado em até 24h para manter ou revogar a medida. O descumprimento das medidas pode ensejar prisão preventiva.', cobrado: 'hot', anos: ['2024', '2023', '2022', '2021'] },
      ...
      secoes: [
        ...
        },
        {
          ...
          artigos: [
            ...
            { id: 'pp_ip2', artigo: 'Art. 10 CPP', titulo: 'Prazo do Inquérito', frente: 'Quais os prazos do inquérito policial?', verso: 'REGRA GERAL (CPP): PRESO: 10 dias, prazo IMPRORROGÁVEL. SOLTO: 30 dias, prorrogável. NA JUSTIÇA FEDERAL: 15 dias (preso, prorrogável por mais 15) e 30 dias (solto). LEI DE DROGAS (regra especial, não confundir com a regra geral): 30 dias (preso) e 90 dias (solto), ambos prorrogáveis por igual período. Findo o prazo, o delegado deverá remeter os autos ao juiz (encerrado ou não).', cobrado: 'hot', anos: ['2023', '2022'] }
          ]
        }
      ]
    },
      ...
      secoes: [
        {
          ...
          artigos: [
            ...
            { id: 'cp_121', artigo: 'Art. 121, § 2º CP', titulo: 'Homicídio Qualificado', frente: 'Quais circunstâncias qualificam o homicídio (tornando-o hediondo)?', verso: 'Motivo torpe ou fútil; Emprego de veneno, fogo, explosivo, asfixia, tortura; Traição, emboscada; Para assegurar execução/ocultação de outro crime; Contra autoridade/agente de segurança pública. ATENÇÃO: FEMINICÍDIO NÃO é mais qualificadora deste §2º desde a Lei 14.994/2024 — o antigo inciso VI foi revogado e o feminicídio passou a ser crime autônomo (Art. 121-A), com pena própria de 20 a 40 anos.', cobrado: 'hot', anos: ['2024', '2023', '2022'] },
      ...
      secoes: [
        {
          ...
          artigos: [
            { id: 'cf_144', artigo: 'Art. 144 CF', titulo: 'Órgãos de Segurança Pública', frente: 'Quais são os órgãos de segurança pública previstos no Art. 144 da CF?', verso: '1) Polícia Federal; 2) Polícia Rodoviária Federal; 3) Polícia Ferroviária Federal; 4) Polícias Civis; 5) Polícias Militares e Corpos de Bombeiros Militares; 6) Polícias Penais Federal, Estaduais e Distrital (incluída pela EC 104/2019). Guardas Municipais (art. 144 §8º) não são órgãos de segurança pública em sentido estrito.', cobrado: 'hot', anos: ['2024', '2023', '2022'] },
        ...
        {
          // Tópico "Princípios Fundamentais (Art. 1-4)" do edital, sem
          // nenhum cartão nesta seção até 2026-09-08 (achado em
          // auditoria da PPRN) — conteúdo idêntico ao publicado antes
          // para a PMPE em data/lei_seca_pmpe.js.
          titulo: '🏛️ Princípios Fundamentais (Art. 1º-4º)',
          artigos: [
