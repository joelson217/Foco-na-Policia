      ...
      secoes: [
        ...
        },
        {
          ...
          artigos: [
            ...
            { id: 'serv_10', artigo: 'Art. 142', titulo: 'Prescrição das Infrações Disciplinares', frente: 'Quais são os prazos prescricionais das infrações disciplinares?', verso: 'ADVERTÊNCIA: 180 DIAS (não confundir com anos — pegadinha clássica). SUSPENSÃO: 2 anos. DEMISSÃO, CASSAÇÃO e DESTITUIÇÃO: 5 anos. A prescrição começa a correr na data em que o fato se tornou conhecido. A abertura do PAD interrompe a prescrição até a decisão final.', cobrado: 'hot', anos: ['2024', '2023'] },
          ]
        }
      ]
    },
      ...
      secoes: [
        {
          ...
          artigos: [
            ...
            { id: 'cp_hom2', artigo: 'Art. 121-A', titulo: 'Feminicídio', frente: 'O que caracteriza o feminicídio e qual o tratamento penal? (ATUALIZADO — Lei 14.994/2024)', verso: 'ATENÇÃO — MUDOU EM 2024: a Lei 14.994/2024 transformou o feminicídio em CRIME AUTÔNOMO (Art. 121-A do CP), deixando de ser mera qualificadora do homicídio (revogado o antigo art. 121, §2º, VI). Caracteriza-se pela morte de mulher por razões da condição de sexo feminino (violência doméstica/familiar OU discriminação/menosprezo à condição de mulher). PENA: reclusão de 20 a 40 anos (mais grave que a do homicídio qualificado comum, que é 12 a 30 anos). Continua sendo CRIME HEDIONDO. Causas de aumento de 1/3 até a metade se: durante gestação/3 meses após o parto, menor de 14, maior de 60, com deficiência, ou na presença de descendente/ascendente da vítima.', cobrado: 'hot', anos: ['2024', '2023', '2022'] },
        ...
        },
        {
          ...
          artigos: [
            { id: 'cp_hon1', artigo: 'Arts. 138-140', titulo: 'Calúnia, Difamação e Injúria', frente: 'Qual a diferença entre calúnia, difamação e injúria?', verso: 'CALÚNIA (138): imputar FATO CRIMINOSO FALSO. Admite a exceção da verdade (salvo ao Presidente, etc.). DIFAMAÇÃO (139): imputar FATO OFENSIVO À REPUTAÇÃO (verdadeiro ou falso). INJÚRIA (140): ofender a DIGNIDADE OU DECORO (não imputa fato, apenas xinga). ATUALIZAÇÃO — Lei 14.532/2023: a antiga "injúria racial" do §3º do art. 140 foi REVOGADA e migrou para a Lei do Racismo (Lei 7.716/89, novo Art. 2º-A), passando a ser tratada como crime de RACISMO — pena de reclusão de 2 a 5 anos, e agora é IMPRESCRITÍVEL e INAFIANÇÁVEL (equiparada aos demais crimes de racismo), não sendo mais um crime do Código Penal contra a honra.', cobrado: 'hot', anos: ['2023', '2022'] },
          ]
        }
      ]
    },
